...
class Up_last1(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        if bilinear:
            ...
            self.up = nn.ConvTranspose2d(in_channels, in_channels // 2, kernel_size=2, stride=1, padding=0)
...
class UNet5_4_M_CONV(nn.Module):
    def __init__(self, n_channels = 1, bilinear=False):
        super(UNet5_4_M_CONV, self).__init__()
...
def model() -> UNet5_4_M_CONV:
    model = UNet5_4_M_CONV()
    return model
