...
class BaseLine1(nn.Module):
    def __init__(self, n_channels = 1):
        ...
        self.down5 = Down(16*Base, 20*Base)
        self.down6 = Down(20*Base, 20*Base)
        
        
        self.up00 = Up(20*Base, 20*Base,False)
        self.up0 = Up(20*Base, 16*Base)
...
# summary(model, [(Input_Image_Channels, 384,384)])

from ptflops import get_model_complexity_info
net = BaseLine1()
flops, params = get_model_complexity_info(net, (1,384,384), as_strings=True,
